...
# -------------------
        ...
        for msg in st.session_state[f"chat_{rollno}"]:
            ...
            if msg_date != last_date:
                chat_html.append(f"<div class='date-separator'>{msg_date.strftime('%A, %d %B %Y')}</div>")
                last_date = msg_date
        ...
        st.markdown("".join(chat_html), unsafe_allow_html=True)  # ✅ FIXED
